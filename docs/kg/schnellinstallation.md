...
> Öffnen Sie **PowerShell als Administrator** (*Windows-Taste → „PowerShell“ eingeben → Rechtsklick → „Als Administrator ausführen“*). Wird PowerShell ohne Administratorrechte gestartet, schlagen die Installationen fehl.
