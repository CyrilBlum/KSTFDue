...
def generate_calendar_html(ical_content, limit=None, title="Kalender", subscribe_url=ICAL_URL, now=None):
    ...
    lines = [
        ...
        "    th, td { box-sizing: border-box; min-width: 0; overflow: hidden; overflow-wrap: anywhere; padding: .5rem .75rem .5rem .25rem; text-align: left; vertical-align: top; }",
    ...
    for month_key, month_events in grouped_events.items():
        ...
        for event in month_events:
            ...
            lines.append(
                ...
                f'<td class="event-content" width="54%" style="width: 54%;">{html.escape(description)}</td>'
                "</tr>"
            )
